...
async function bootstrap() {
    ...
    const config = new swagger_1.DocumentBuilder()
        ...
        .setDescription('ABDM Sandbox Compliance API Bridge. Standardizes patient identification across healthcare providers. ' +
    ...
    swagger_1.SwaggerModule.setup('api/abdm/docs', app, document);
