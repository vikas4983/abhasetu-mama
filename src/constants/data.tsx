...
export const searchableServices: ServiceSummary[] = [
  ...
  { title: 'About ABHA SETU', route: '/about', icon: Info, desc: 'Vision, mission, and healthcare innovation story.' },
  { title: 'Contact ABHA SETU', route: '/contact', icon: Phone, desc: 'Email, phone, address, and proposal form.' },
  { title: 'ABDM V3 Workflows', route: '/abdm', icon: IdCard, desc: 'ABHA creation, verification, card, and QR flows.' },
