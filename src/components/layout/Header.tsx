...
export default function Header() {
  ...
  const [profileView, setProfileView] = useState<"details" | "update-mobile">(
    "details",
  );
    ...
    const searchableItems: SearchItem[] = [
      {
        ...
        route: "abha",
        icon: "id-card",
        desc: "Create, view, download or verify ABHA Card.",
      },
      {
        type: "Services",
        title: "PHR — Personal Health Records",
        route: "phr",
        icon: "folder-lock",
        desc: "PHR enrollment, ABHA login, consent PIN, and health locker.",
      },
      {
        type: "Services",
        ...
        route: "records",
        icon: "folder-lock",
        desc: "Access clinical records, consent history, and decrypted bundles.",
      },
      {
        type: "Services",
        ...
        route: "health",
        icon: "activity",
        desc: "Real-time vitals, SpO2, heart rate, blood pressure, and Health ATM metrics.",
      },
      {
        type: "Services",
        ...
        route: "qr-scanner",
        icon: "qr-code",
        desc: "Scan HFR hospital QR codes for instant OPD registrations.",
      },
      {
        type: "Services",
        title: "About Us",
        route: "about",
        icon: "graduation-cap",
        desc: "Learn about Abha Setu and ABDM integration mission.",
      },
      {
        type: "Services",
        ...
        route: "pharmacy",
        icon: "pill",
        desc: "Browse OTC/Prescription medicines, add to cart.",
      },
      {
        type: "Services",
        ...
        route: "lab-tests",
        icon: "flask-conical",
        desc: "Book NABL diagnostics, check slots, and sync ABHA.",
      },
      {
        type: "Services",
        ...
        route: "connected",
        icon: "building-2",
        desc: "Verified HFR hospitals directory, check-in queues.",
      },
      {
        type: "Services",
        ...
        route: "more",
        icon: "droplet",
        desc: "Check blood units availability, request or donate blood.",
      },
      {
        type: "Services",
        ...
        desc: "Submit organ transplant pledge, download NHA certificate.",
      },
      {
        type: "Services",
        ...
        route: "connected",
        icon: "building",
        desc: "Scan and share at active hospitals and diagnostics.",
      },
      {
        type: "Services",
        ...
        route: "security",
        icon: "shield-check",
        desc: "Check role permissions, token logs, security credentials.",
      },
      {
        type: "Services",
        title: "ABDM Sandbox API Documentation",
        route: "sandbox",
        icon: "code",
        desc: "Interactive developer documentation, live playground network test runners.",
      },
      {
        type: "Services",
      ...
      },
      {
        ...
        route: "settings",
        icon: "accessibility",
        desc: "Font sizes, screen reader, high contrast options.",
      },
      {
        type: "Services",
        ...
        route: "settings",
        icon: "languages",
        desc: "Select multilingual preferences.",
      },
      {
        type: "Services",
        ...
        route: "appointments",
        icon: "video",
        desc: "Enter private virtual health appointment room.",
      },
      {
        type: "Hospitals",
        ...
        route: "connected",
        icon: "building-2",
        desc: "HFR: IN2310026968 | Gurudev Colony, Jabalpur",
      },
      {
        type: "Hospitals",
        ...
        route: "connected",
        icon: "heart-pulse",
        desc: "HFR: IN2310026365 | Bhopal, Madhya Pradesh, India",
      },
      {
        type: "Doctors",
        title: "Dr. Ayesha Ali",
        route: "appointments",
        icon: "user-round",
        desc: "Senior Homeopathy Consultant & Telehealth Lead | 35 yrs exp",
      },
      {
        type: "Doctors",
        title: "Dr. Yogyata Mukhraiya",
        route: "appointments",
        icon: "user-round",
        desc: "Chronic Diseases and Female Problems Specialist | 12 yrs exp",
      },
      {
        type: "Doctors",
        title: "Amitendu Giradonia",
        route: "appointments",
        icon: "user-round",
        desc: "Homeopathy and Primary Care Specialist | 18 yrs exp",
      },
      {
        type: "Blood Donors",
        title: "Ashish Patel (B+)",
        route: "more",
        icon: "user-round",
        desc: "Age: 33 Years | Contact: 9981435702 | Last: 3 months ago",
      },
      {
        type: "Blood Donors",
        title: "Anant Agrahri (B+)",
        route: "more",
        icon: "user-round",
        desc: "Age: 32 Years | Contact: 9977756362 | Last: 3 months ago",
      },
      {
        type: "Medicines",
        ...
        route: "pharmacy",
        icon: "pill",
        desc: "Price: ₹40 | For relief of fever and mild to moderate pain.",
      },
      {
        type: "Medicines",
        ...
        route: "pharmacy",
        icon: "pill",
        desc: "Price: ₹120 | Broad-spectrum antibiotic for bacterial infections.",
      },
      {
        type: "Courses",
        ...
        route: "courses",
        icon: "graduation-cap",
        desc: "CPR training and basic life support certificate.",
      },
      {
        type: "Courses",
        title: "ABDM Integration Training",
        route: "courses",
        icon: "graduation-cap",
        desc: "Training for health facilities to integrate under Ayushman Bharat.",
      },
      {
        type: "Insurance",
        title: "Ayushman Bharat PM-JAY Policy",
        route: "insurance",
        icon: "shield-check",
        desc: "Verify eligibility and link PM-JAY insurance cards.",
      },
      {
        type: "Labs",
        title: "ECG Diagnostic Screening",
        route: "lab-tests",
        icon: "activity",
        desc: "Diagnostic lab slot for heart screening scans.",
      },
      {
        type: "Labs",
        title: "NABL Pathology Lab Tests",
        route: "lab-tests",
        icon: "flask-conical",
        desc: "NABL certified blood tests and sample collection.",
      },
      {
        type: "Departments",
        ...
        route: "connected",
        icon: "heart-pulse",
        desc: "Heart health specialist consultations, cardiology clinic.",
      },
      {
        ...
        route: "more",
        icon: "ambulance",
        desc: "Simulated rapid ambulance dispatch and tracking.",
      },
    ].concat(dynamicItems);

    const matches = searchableItems
      .filter((item) =>
        `${item.title} ${item.desc} ${item.type}`.toLowerCase().includes(q),
      )
      .slice(0, 10);
  ...
  const renderIcon = (name: string) => {
    switch (name) {
      case "id-card":
        return <Plus className="small-icon" />;
      case "pill":
        return <Pill className="small-icon" />;
      case "flask-conical":
        return <FlaskConical className="small-icon" />;
      case "building-2":
        return <Building className="small-icon" />;
      case "droplet":
        return <Droplet className="small-icon" />;
      case "heart-handshake":
        return <HeartHandshake className="small-icon" />;
      case "building":
        return <Building className="small-icon" />;
      case "shield-check":
        return <ShieldCheck className="small-icon" />;
      case "palette":
        return <Palette className="small-icon" />;
      case "accessibility":
        return <Accessibility className="small-icon" />;
      case "languages":
        return <Languages className="small-icon" />;
      case "graduation-cap":
        return <GraduationCap className="small-icon" />;
      case "activity":
        return <Activity className="small-icon" />;
      case "heart-pulse":
        return <HeartPulse className="small-icon" />;
      case "brain-circuit":
        return <BrainCircuit className="small-icon" />;
      case "ambulance":
        return <Ambulance className="small-icon" />;
      case "qr-code":
        return <QrCode className="small-icon" />;
      case "folder-lock":
        return <FolderLock className="small-icon" />;
      case "video":
        return <Video className="small-icon" />;
      case "user-round":
        return <UserRound className="small-icon" />;
      case "file-text":
        return <FileText className="small-icon" />;
      default:
        return <Search className="small-icon" />;
    }
  };
    ...
    <>
      <header className="header">
        <div className="header-inner">
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  selectedLogo !== "default"
                    ? "none"
                    : "0 12px 28px color-mix(in srgb, var(--accent-teal) 24%, transparent)",
                display: "flex",
                alignItems: "center",
          ...
          <div
            ref={searchRef}
            className={`global-search ${isSearchActive ? "is-active" : ""}`}
            role="search"
          >
            <Search
          ...
          <div className="header-actions">
            ...
            {!sessionExpired &&
              ...
              localStorage.getItem("abha_session_expiry") && (
                <div
                  className="desktop-only-timers"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: "8px",
                    padding: "4px 10px",
                    background: "rgba(39, 56, 144, 0.08)",
                    borderRadius: "8px",
